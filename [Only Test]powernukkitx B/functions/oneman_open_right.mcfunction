...
execute as @s[tag=!backward] at @s run event entity @e[tag=body,r=1] oneman_open_b   
tag @s[tag=!backward]add oneman_open_b 
execute as @s[tag=backward] at @s run event entity @e[tag=body,r=1] oneman_open_a   
